...
class csv_save():
	def __init__(self):
		...
		self.filename = homedir + "/2020-self-driving-car-project/result/" + str(date) + "_" + str(time) + ".csv"
		# self.filename = "/home/alex/2020-self-driving-car-project/catkin_ws/src/localization/test.csv"
		self.result = rospy.Subscriber("/result", PoseStamped, self.callback, queue_size=10)
	...
	def callback(self, msg):
		...
		pitch = euler[1]
		yaw = euler[2]
		self._t.append(str(msg.header.stamp))
